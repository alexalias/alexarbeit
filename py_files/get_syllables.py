...
def syl_position(datei, word_no):
	#print("Cursor: " + str(cursor))
	syls_word = get_sylsplit_word(datei, word_no)
	w12 = mau_split(datei, word_no)#, cursor)
	mau12, sylsplit_word = prepare_strings(w12, syls_word)
	syl_dict = defaultdict(list)
	#print("MAU1: " + mau1)
	if sylsplit_word != "":
		syl_dict = compare_strings(mau12, sylsplit_word)
...
def prepare_strings(w12, sylsplit_word):
	for el in w12:
		if el == "Q":
			w12 = w12.replace("Q", "")
